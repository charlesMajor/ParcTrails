...
axiosAuth.interceptors.request.use(config => {
  ...
  if (authstore.isLoggedIn) {
    if (authstore.isTokenExpired) {
      ...
      // On pourrait gérer ici la demande pour obtenir un nouveau token avec le jeton de rafraîchissement.
      // authstore.refreshToken()
      // Dans le contexte du cours, on va simplement considérer que le jeton est toujours valide.
    }
